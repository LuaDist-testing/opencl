...
table.insert(tests, function(device)
  ...
  assert(type(device:get_info("image2d_max_height") or 0) == "number")
  assert(type(device:get_info("image2d_max_width") or 0) == "number")
  assert(type(device:get_info("image3d_max_depth") or 0) == "number")
  assert(type(device:get_info("image3d_max_height") or 0) == "number")
  assert(type(device:get_info("image3d_max_width") or 0) == "number")
  ...
  assert(type(device:get_info("max_read_image_args") or 0) == "number")
  ...
  assert(type(device:get_info("max_write_image_args") or 0) == "number")
